...
堆内存的大小。如果应用程序将发送大量需要复制的数据，则应将其设置为高*/
...
The STM32F4x7 allows computing and verifying the IP, UDP, TCP and ICMP checksums by hardware:
 ...
 STM32F4x7允许通过硬件计算和验证IP，UDP，TCP和ICMP校验和：
 要使用此功能，请在下面的注释中取消注释。 要禁用它并由CPU处理，请检查校验和。
*/
...
*/ 
#define 	LWIP_TCPIP_CORE_LOCKING   1 //优化选项，设置为1则无需操作系统的邮箱与信号量参与直接在用户线程中通过回调函数调用相应的处理
