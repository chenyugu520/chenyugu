...
/** 
  ...
  *   By calling the ETH_StructInit function the structure锟絪 fields are set to their default values.
...
/** 
  * @brief  ETH DMA Descriptors data structure definitionETH DMA描述符数据结构定义
  */ 
typedef struct  {
  __IO uint32_t   Status;                /*!< Status 状态*/ 
  uint32_t   ControlBufferSize;     /*!< Control and Buffer1, Buffer2 lengths */
  uint32_t   Buffer1Addr;           /*!< Buffer1 address pointer   缓冲区地址 */
