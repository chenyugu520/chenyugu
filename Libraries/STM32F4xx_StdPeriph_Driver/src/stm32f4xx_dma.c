...
/**
  ...
  *          This parameter can be any combination of the following values:
  *            @arg DMA_IT_TC:  Transfer complete interrupt mask传输完整的中断
  *            @arg DMA_IT_HT:  Half transfer complete interrupt mask半传输完成中断
  *            @arg DMA_IT_TE:  Transfer error interrupt mask传输错误中断
  *            @arg DMA_IT_FE:  FIFO error interrupt maskFIFO错误中断
...
/**
  ...
  *          This parameter can be any combination of the following values:
  *            @arg DMA_IT_TCIFx:  Streamx transfer complete interrupt  Streamx传输完成中断
  *            @arg DMA_IT_HTIFx:  Streamx half transfer complete interrupt  Streamx半传输完成中断
  *            @arg DMA_IT_TEIFx:  Streamx transfer error interrupt   Streamx传输错误中断
  *            @arg DMA_IT_DMEIFx: Streamx direct mode error interrupt   Streamx直接模式错误中断
  *            @arg DMA_IT_FEIFx:  Streamx FIFO error interrupt   Streamx FIFO错误中断
  *         Where x can be 0 to 7 to select the DMA Stream.
  * @retval None
  */
void DMA_ClearITPendingBit(DMA_Stream_TypeDef* DMAy_Streamx, uint32_t DMA_IT)
